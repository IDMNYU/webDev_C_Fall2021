...
```
Intro to Web Development - Fall 2021
DM-UY 2193 Section C | September 2 - December 20
Monday + Wednesday 10:00 - 11:50 am | IDM - Room 311
```
***
```
...
#### [Course Schedule](schedule.md) and [Course Syllabus]() and [Course wiki](https://github.com/IDMNYU/webDev_C_Fall2021/wiki)
...
Weekly Design + Technical Exercises + Class Site (35% of grade): will be executed through the semester by following in class demonstrations, online tutorials and assigned readings. These exercises will be essential for learning markup and coding and to successfully complete more complex projects.
